...
router
  ...
  .post('/', auth.verifyAccess, admin.onlyAdmin, uploadMulter.single('image'), cinemasController.insertcinemas)
  .put('/:id', auth.verifyAccess, admin.onlyAdmin, uploadMulter.single('image'), cinemasController.updatecinemas)
